...
*/
public class RequestContextArgResolver implements LocalArgResolver
{
    /* (non-Javadoc)
    ...
    public Object resolveArg(Object context) throws LocalArgResolveException{
    	...
    	else if(context instanceof HttpServletRequest){
    		try{
    			requestContext = new RequestContext((HttpServletRequest)context);
